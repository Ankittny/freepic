        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown"><a class="nav-link menu-title" href="{{ url('deshboard') }}"><i data-feather="home"></i><span>Dashboard</span></a></li>
                    ...
                    <li class="dropdown"><a class="nav-link menu-title link-nav" href="{{asset("public/admin")}}/starter-kit/index.html"><i data-feather="anchor"></i><span>Starter kit </span></a></li>
