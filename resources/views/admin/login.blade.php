...
<head>
    ...
    <link rel="icon" href="{{ asset('admin/public') }}/assets/images/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('admin/public') }}/assets/images/favicon.png" type="image/x-icon">
    <title>viho - Premium Admin Template</title>
    <!-- Google font-->
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="{{ asset('public/admin/') }}/css2?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&amp;display=swap" rel="stylesheet">
    <link href="{{ asset('public/admin/') }}/css2-1?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&amp;display=swap" rel="stylesheet">
    <link href="{{ asset('public/admin/') }}/css2-2?family=Rubik:ital,wght@0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&amp;display=swap" rel="stylesheet">
    <!-- Font Awesome-->
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="login-card">
                        ...
                        <form class="theme-form login-form" action="{{ url('login') }}" method="Post">
                            @csrf
                            <h4>Admin</h4>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group"><span class="input-group-text"><i class="icon-email"></i></span>
                                    <input class="form-control" type="email" required="" name="username" placeholder="Test@gmail.com">
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        @if(Session::has('error'))
                            <span class="error" style="color:red;">{!! \Session::get('error') !!}</span>
                          @endif
